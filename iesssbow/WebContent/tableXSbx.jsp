                ...
                <li><a href="#"><img src="${ctx }/img/icons/menu/factory.png" alt="" /> 疑难问题管理</a>
                 ...
                 <li class="current"><a href="#"><img src="${ctx }/img/icons/menu/lab.png" alt="" />学生管理</a>
                    <ul>
                        ...
                        <li class="current"><a href="${ctx }/student/list_bx">巴西学生</a></li>
    ...
    <div class="content">
                 ...
                 <c:forEach items="${page.list}" var="p">
					...
					<tr>
					   ...
					   <td>
						...
						<a href="${ctx }/student/delete_bx?id_Stu=${p.id_Stu}" title="删除信息"><img src="${ctx }/img/icons/actions/delete.png"/></a>
						</td>
				   </tr>
        ...
        <div class="pagination">
        	<c:forEach begin="1" end="${page.totalPageNum }" var="pageNum">
				<a name="pagen"  href="${ctx }/student/list_bx?pageNum=${pageNum }" class="current">${pageNum }</a>
			</c:forEach>
        </div>
    </div>
</div>
